...
const fs = require('fs');
const towerData = require('./src/services/towerData.js');
...
const finalTower1 = towerData.tower1Data.map(f => Object.assign({}, f, { d: transformPath(f.d, t1) }));
const finalTower2 = towerData.tower2Data.map(f => Object.assign({}, f, { d: transformPath(f.d, t2) }));
const finalTower3 = towerData.tower3Data.map(f => Object.assign({}, f, { d: transformPath(f.d, t3) }));
