  ...
  return (
    <button
      ...
      style={{
        ...
        border: 'none', borderRadius: '12px', padding: '0.55rem 0.75rem', cursor: 'pointer',
        color: isActive ? '#fff' : 'rgba(255,255,255,0.55)', transition: 'background 0.3s ease, color 0.3s ease',
        fontFamily: 'var(--font-display)', textAlign: 'left'
      }}
    >
      <span style={{
        display: 'flex', alignItems: 'center', justifyContent: 'center', width: '30px', height: '30px',
        borderRadius: '9px', flexShrink: 0, background: isActive ? GOLD_SOFT : 'rgba(255,255,255,0.05)',
        border: isActive ? `1px solid ${GOLD}` : '1px solid rgba(255,255,255,0.08)', transition: 'all 0.3s ease'
      }}>
        <item.icon size={14} color={isActive ? GOLD : 'currentColor'} />
      </span>
      <span className="nav-label" style={{ fontSize: '0.78rem', fontWeight: isActive ? 700 : 500, whiteSpace: 'nowrap', flex: 1 }}>
        {item.title}
      </span>
      {typeof mediaCount === 'number' && (
        <span className="nav-count" style={{
          fontSize: '0.62rem', fontWeight: 700, color: isActive ? GOLD : 'rgba(255,255,255,0.35)',
          background: 'rgba(255,255,255,0.05)', borderRadius: '20px', padding: '0.1rem 0.4rem', flexShrink: 0
        }}>
          {mediaCount}
        </span>
      )}
...
const FloatingNav = ({ activeId, onNavigate }) => {
  ...
  return (
    <nav className="floating-nav" style={{
      position: 'fixed', left: '1.5rem', top: '50%', transform: 'translateY(-50%)', zIndex: 40,
      background: 'rgba(7,7,10,0.55)', border: '1px solid rgba(56,189,248,0.18)', borderRadius: '20px',
      backdropFilter: 'blur(18px)', padding: '0.9rem 0.6rem', boxShadow: '0 20px 50px rgba(0,0,0,0.5)',
...
const AnimatedStat = ({ label, value }) => {
  ...
  return (
    ...
    >
      <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: '4px' }}>
        {label}
      </div>
      <div style={{ color: 'white', fontSize: '1.15rem', fontWeight: 700, fontFamily: 'var(--font-display)' }}>
  ...
  return (
    <div
      ...
      style={{
        ...
        overflow: 'hidden', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 30px 70px rgba(0,0,0,0.6)'
      }}
    >
      ...
      <motion.div
        ...
        style={{
          ...
          background: 'rgba(10,10,14,0.45)', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(14px)',
      ...
      >
        ...
        <h2 style={{ margin: '0 0 0.5rem 0', fontFamily: 'var(--font-display)', fontSize: 'clamp(1.8rem, 3.4vw, 2.8rem)', fontWeight: 800, color: 'white', letterSpacing: '-0.5px' }}>
          {section.title}
        </h2>
        <p style={{ margin: 0, color: 'rgba(255,255,255,0.7)', fontSize: '0.95rem', maxWidth: '560px', lineHeight: 1.6 }}>
          {section.tagline}
        </p>
        <button
          ...
          style={{
            ...
            background: 'transparent', border: `1px solid ${GOLD}`, color: GOLD, borderRadius: '30px',
            padding: '0.55rem 1.2rem', fontSize: '0.78rem', fontWeight: 700, cursor: 'pointer',
            textTransform: 'uppercase', letterSpacing: '0.5px', fontFamily: 'var(--font-display)'
          }}
        >
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          border: '1px solid rgba(255,255,255,0.1)', cursor: 'ew-resize', userSelect: 'none',
      ...
      >
        ...
        <span style={{ position: 'absolute', top: '1rem', left: '1rem', background: 'rgba(7,7,9,0.65)', border: '1px solid rgba(255,255,255,0.15)', color: 'white', fontSize: '0.68rem', fontWeight: 700, padding: '0.3rem 0.75rem', borderRadius: '20px', textTransform: 'uppercase', letterSpacing: '0.4px' }}>
          {data.beforeLabel}
        </span>
        <span style={{ position: 'absolute', top: '1rem', right: '1rem', background: 'rgba(7,7,9,0.65)', border: `1px solid ${GOLD}`, color: GOLD, fontSize: '0.68rem', fontWeight: 700, padding: '0.3rem 0.75rem', borderRadius: '20px', textTransform: 'uppercase', letterSpacing: '0.4px' }}>
          {data.afterLabel}
        </span>
        ...
        <div style={{
          ...
          width: '42px', height: '42px', borderRadius: '50%', background: 'rgba(7,7,9,0.85)', border: `1px solid ${GOLD}`,
...
const MediaCard = memo(({ item, index, onOpen }) => {
  ...
  const handleMouseEnter = () => {
    ...
    card.style.boxShadow = `0 0 0 1px ${GOLD_SOFT}, 0 20px 45px rgba(0,0,0,0.55), 0 0 26px rgba(56,189,248,0.28)`;
    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: '20px', overflow: 'hidden', cursor: 'zoom-in', border: '1px solid rgba(255,255,255,0.07)',
          background: '#101014', boxShadow: '0 10px 30px rgba(0,0,0,0.45)',
      ...
      >
        ...
        {isVideo && (
          <div style={{ position: 'absolute', top: '0.8rem', left: '0.8rem', display: 'flex', alignItems: 'center', gap: '5px', background: 'rgba(7,7,9,0.65)', border: `1px solid ${GOLD}`, borderRadius: '20px', padding: '0.25rem 0.65rem', fontSize: '0.6rem', fontWeight: 700, color: GOLD, textTransform: 'uppercase' }}>
        ...
        <button
          ...
          style={{
            ...
            background: 'rgba(7,7,9,0.55)', border: '1px solid rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center',
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '0.9rem', background: 'linear-gradient(to top, rgba(5,5,8,0.85), transparent)' }}>
          <span style={{ color: 'rgba(255,255,255,0.85)', fontSize: '0.75rem', fontWeight: 600 }}>{item.caption}</span>
        </div>
      </div>
    </motion.div>
  );
    ...
    {TIMELINE_STEPS.map((step, i) => (
      <React.Fragment key={step.label}>
        ...
        >
          ...
          <span style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.75)', fontWeight: 600, whiteSpace: 'nowrap' }}>{step.label}</span>
        </motion.div>
    ...
    <section id={section.id} ref={ref} style={{ position: 'relative', zIndex: 1, padding: '3.5rem 0', scrollMarginTop: '2rem' }}>
      ...
      {section.description && (
        <motion.p
          ...
          style={{ color: 'rgba(255,255,255,0.72)', fontSize: '1rem', lineHeight: 1.75, maxWidth: '760px', margin: '2rem 0 0 0' }}
        >
          {section.description}
        </motion.p>
      )}
      ...
      {section.highlights && (
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', margin: '1.25rem 0 0 0' }}>
          {section.highlights.map((h) => (
            <span key={h} style={{
              display: 'inline-flex', alignItems: 'center', gap: '6px', fontSize: '0.78rem', color: 'rgba(255,255,255,0.8)',
              background: 'rgba(56,189,248,0.07)', border: '1px solid rgba(56,189,248,0.2)', borderRadius: '20px', padding: '0.4rem 0.9rem'
            }}>
        ...
        <div style={{ marginTop: '2rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
            {section.materials.map((m) => (
              <span key={m} style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.85)', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '20px', padding: '0.35rem 0.85rem' }}>{m}</span>
            ))}
          </div>
        </div>
      )}
      ...
      {section.testimonial && (
        <motion.div
          ...
          style={{ marginTop: '2.5rem', padding: '1.75rem 2rem', borderRadius: '20px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', maxWidth: '640px' }}
        >
          <Quote size={20} color={GOLD} style={{ marginBottom: '0.75rem' }} />
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '1rem', lineHeight: 1.6, fontStyle: 'italic', margin: '0 0 0.75rem 0' }}>
            &ldquo;{section.testimonial.quote}&rdquo;
          </p>
          <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.8rem', fontWeight: 600 }}>{section.testimonial.author}</span>
        </motion.div>
      )}
    </section>
  );
...
const ProjectViewer = ({ section, index, onClose, onPrev, onNext }) => {
  ...
  return (
    <motion.div
      ...
      style={{ position: 'fixed', inset: 0, zIndex: 400, background: 'rgba(4,4,7,0.97)', backdropFilter: 'blur(18px)', display: 'flex', overflowY: 'auto' }}
    >
      <button onClick={onClose} style={{ position: 'absolute', top: '1.5rem', right: '4%', zIndex: 420, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.12)', color: 'white', cursor: 'pointer', borderRadius: '50%', width: '42px', height: '42px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <X size={18} />
      </button>
      ...
      <div onClick={(e) => e.stopPropagation()} style={{ margin: 'auto', width: '92%', maxWidth: '1180px', padding: '5rem 0 3rem', display: 'grid', gridTemplateColumns: 'minmax(0,1.6fr) minmax(220px,1fr)', gap: '2.5rem' }} className="viewer-grid">
        <div>
          <div style={{ position: 'relative', borderRadius: '20px', overflow: 'hidden', border: `1px solid ${GOLD_SOFT}`, boxShadow: '0 25px 60px rgba(0,0,0,0.8)' }}>
            ...
            {item.type !== 'video' && (
              <div style={{ position: 'absolute', bottom: '0.8rem', right: '0.8rem', background: 'rgba(7,7,9,0.6)', borderRadius: '20px', padding: '0.35rem 0.7rem', display: 'flex', alignItems: 'center', gap: '5px', fontSize: '0.65rem', color: 'rgba(255,255,255,0.7)' }}>
        ...
        <div>
          ...
          <h2 style={{ margin: '6px 0 1rem', fontFamily: 'var(--font-display)', fontSize: '1.6rem', fontWeight: 800, color: 'white' }}>{item.caption}</h2>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.88rem', lineHeight: 1.7, marginBottom: '1.5rem' }}>{section.description || section.tagline}</p>
          ...
          <div style={{ marginTop: '2rem', color: 'rgba(255,255,255,0.35)', fontSize: '0.75rem' }}>{index + 1} / {section.media.length}</div>
        </div>
      </div>
    </motion.div>
  );
...
const tagChip = { fontSize: '0.75rem', color: 'rgba(255,255,255,0.85)', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '20px', padding: '0.3rem 0.75rem' };
...
const WalkthroughModal = ({ onClose }) => {
  ...
  return (
    ...
    >
      <button onClick={onClose} style={{ position: 'absolute', top: '1.5rem', right: '4%', zIndex: 520, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.12)', color: 'white', cursor: 'pointer', borderRadius: '50%', width: '42px', height: '42px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <X size={18} />
      </button>
      <motion.div
      ...
      >
        <div style={{ marginBottom: '1rem', textAlign: 'center' }}>
          ...
          <h2 style={{ margin: '0.4rem 0 0', color: 'white', fontFamily: 'var(--font-display)', fontSize: 'clamp(1.4rem, 2.6vw, 2rem)', fontWeight: 800 }}>{MASTER_WALKTHROUGH.title}</h2>
        </div>
        <div style={{ position: 'relative', borderRadius: '22px', overflow: 'hidden', border: `1px solid ${GOLD_SOFT}`, boxShadow: '0 30px 80px rgba(0,0,0,0.85)' }}>
          ...
          <button
            ...
            style={{
              position: 'absolute', bottom: '1rem', right: '1rem', background: 'rgba(7,7,9,0.7)', border: '1px solid rgba(255,255,255,0.15)',
              color: 'white', borderRadius: '50%', width: '38px', height: '38px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer'
            }}
          >
...
const Gallery = () => {
  ...
  return (
    <motion.div
      ...
      style={{ position: 'relative', paddingTop: '90px', minHeight: '100vh', background: '#050608', color: 'white', paddingBottom: '4rem', overflowX: 'hidden' }}
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', padding: '0 4% 2rem' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 800, margin: '0 0 0.5rem 0', letterSpacing: '-0.5px' }}>
...
// const Gallery = () => {
//   const allImages = [
//     { id: 0, category: 'family-living', label: 'Luxury Lounge', img: '/images/gallery/1.jpg' },
//     { id: 1, category: 'family-living', label: 'Premium Seating', img: '/images/gallery/2.jpg' },
//     { id: 2, category: 'entertainment', label: 'Gaming Zone', img: '/images/gallery/3.jpg' },
//     { id: 3, category: 'entertainment', label: 'Movie Room', img: '/images/gallery/4.jpg' },
//     { id: 4, category: 'dry-kitchen', label: 'Dry Kitchen View', img: '/images/gallery/5.jpg' },
//     { id: 5, category: 'dry-kitchen', label: 'Premium Storage', img: '/images/gallery/03.jpg' },
//     { id: 6, category: 'bedroom', label: 'Master Bedroom', img: '/images/gallery/7.jpg' },
//     { id: 7, category: 'bedroom', label: 'Guest Bedroom', img: '/images/gallery/8.jpg' },
//     { id: 8, category: 'bedroom', label: 'Luxury Suite', img: '/images/gallery/9.jpg' }
//   ];

//   const categories = [
//     { id: 'all', title: 'All' },
//     { id: 'family-living', title: 'Family Living' },
//     { id: 'entertainment', title: 'Entertainment' },
//     { id: 'dry-kitchen', title: 'Dry Kitchen' },
//     { id: 'bedroom', title: 'Bedroom Suites' }
//   ];
...
//           Experience the premium textures and refined architectural aesthetics of Aparna Sarovar Towers. Click on any image to view details.
//         </p>
...
//                 const overlay = e.currentTarget.querySelector('.overlay-cover');
...
//                   width: '100%',
//                   height: '100%',
//                   background: 'linear-gradient(to top, rgba(7, 7, 9, 0.8) 0%, rgba(7, 7, 9, 0.1) 100%)',
//                   opacity: 0,
//                   display: 'flex',
//                   flexDirection: 'column',
...
//                     </span>
//                     <h3 style={{ margin: '2px 0 0 0', fontSize: '0.95rem', fontWeight: '700', color: 'white' }}>
//                       {item.label}
//                     </h3>
//                   </div>
//                   <div style={{
...
//               alignItems: 'center',
//               zIndex: 210,
//               background: 'linear-gradient(to bottom, rgba(5,5,8,0.8), rgba(0,0,0,0))'
//             }}>
//               <div>
...
//                 </span>
//                 <h2 style={{ margin: '4px 0 0 0', fontFamily: 'var(--font-display)', fontSize: '1.25rem', fontWeight: '700', color: 'white' }}>
...
//               <AnimatePresence mode="wait">
//                 <motion.img 
//                   key={filteredImages[lightboxIndex].img}
...
//    Programmatically assembled so the 16 requested rooms/zones each get a
//    hero, stats, mixed-media wall, a design -> construction -> completion
//    -> walkthrough story strip, and materials, without hand-typing near-
//    duplicate content 16 times. Swap the img/videoSrc paths for real
//    assets; everything else is real, considered copy.
// ========================================================================= */
// const CATEGORY_META = [
//   { id: 'exterior', title: 'Exterior', icon: Building2, tagline: 'The first impression, engineered to last generations.' },
//   { id: 'living-room', title: 'Living Room', icon: Sofa, tagline: "Where the family's day begins and ends." },
...
// const ORIENTATIONS = ['wide', 'normal', 'tall', 'normal', 'wide'];

// /* Your actual uploaded assets, mapped onto the closest matching zone.
//    Everything else in the experience still uses placeholder paths
//    (`/images/gallery/<zone>/1.jpg`, etc.) until you add more real photos -
//    just add entries here in the same shape and they'll slot straight in. */
// const REAL_MEDIA_BY_ID = {
//   'living-room': [
//     { img: '/images/gallery/1.jpg', caption: 'Luxury Lounge' },
//     { img: '/images/gallery/2.jpg', caption: 'Premium Seating' }
//   ],
//   'family-entertainment': [
//     { img: '/images/gallery/3.jpg', caption: 'Gaming Zone' },
//     { img: '/images/gallery/4.jpg', caption: 'Movie Room' }
//   ],
//   'dry-kitchen': [
//     { img: '/images/gallery/5.jpg', caption: 'Dry Kitchen View' },
//     { img: '/images/gallery/03.jpg', caption: 'Premium Storage' }
//   ],
//   'master-bedroom': [
//     { img: '/images/gallery/7.jpg', caption: 'Master Bedroom' }
//   ],
//   'bedroom-suites': [
//     { img: '/images/gallery/8.jpg', caption: 'Guest Bedroom' },
//     { img: '/images/gallery/9.jpg', caption: 'Luxury Suite' }
//   ]
// };
...
//           const isVideo = (sIdx + i) % 4 === 0;
//           return {
//             id: `${meta.id}-${i}`,
//             type: isVideo ? 'video' : 'image',
//             orientation,
//             img: `/images/gallery/${meta.id}/${i + 1}.jpg`,
//             videoSrc: isVideo ? `/videos/gallery/${meta.id}-${i % 2 === 0 ? 'flythrough' : 'timelapse'}.mp4` : undefined,
//             caption: isVideo ? `${meta.title} - motion capture` : `${meta.title} - detail ${i + 1}`
//           };
//         });

//     const hero = realMedia
//       ? { type: 'image', img: realMedia[0].img }
//       : {
//           type: sIdx % 5 === 0 ? 'video' : 'image',
//           img: `/images/gallery/${meta.id}/hero.jpg`,
//           videoSrc: sIdx % 5 === 0 ? `/videos/gallery/${meta.id}-hero.mp4` : undefined
//         };
...
//    FLOATING LEFT NAVIGATION
// ========================================================================= */
// const NavButton = memo(({ item, isActive, onClick, setRef }) => {
//   const btnRef = useRef(null);
...
//         <item.icon size={14} color={isActive ? GOLD : 'currentColor'} />
//       </span>
//       <span className="nav-label" style={{ fontSize: '0.78rem', fontWeight: isActive ? 700 : 500, whiteSpace: 'nowrap' }}>
//         {item.title}
//       </span>
//     </button>
//   );
...
//             <NavButton key={item.id} item={item} isActive={activeId === item.id} onClick={onNavigate} setRef={setRef} />
//           ))}
//         </div>
//       </div>
//     </nav>
...
//       viewport={{ once: true, margin: '-60px' }}
//       transition={{ duration: 0.55, ease: EASE, delay: (index % 5) * 0.06 }}
//       style={{ gridColumn: span.col, gridRow: span.row }}
//     >
//       <div
//         ref={cardRef}
...
//       <div ref={mediaRef} className="media-grid" style={{
//         display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))',
//         gridAutoRows: '220px', gap: '1.25rem', scrollMarginTop: '2rem'
//       }}>
//         {section.media.map((item, i) => (
//           <MediaCard key={item.id} item={item} index={i} onOpen={(idx) => onOpenViewer(section.id, idx)} />
//         ))}
//       </div>
...
//       <div onClick={(e) => e.stopPropagation()} style={{ margin: 'auto', width: '92%', maxWidth: '1180px', padding: '5rem 0 3rem', display: 'grid', gridTemplateColumns: 'minmax(0,1.6fr) minmax(260px,1fr)', gap: '2.5rem' }} className="viewer-grid">
//         <div>
//           <div style={{ position: 'relative', borderRadius: '20px', overflow: 'hidden', border: `1px solid ${GOLD_SOFT}`, boxShadow: '0 25px 60px rgba(0,0,0,0.8)' }}>
//             <AnimatePresence mode="wait">
//               <motion.div key={item.id} initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.97 }} transition={{ duration: 0.3, ease: 'easeOut' }}>
...
//             {section.media.map((thumb, i) => (
//               <button key={thumb.id} onClick={(e) => { e.stopPropagation(); i > index ? onNext() : i < index ? onPrev() : null; }}
//                 style={{ flexShrink: 0, width: '76px', height: '52px', borderRadius: '10px', overflow: 'hidden', border: i === index ? `2px solid ${GOLD}` : '1px solid rgba(255,255,255,0.12)', padding: 0, cursor: 'pointer', opacity: i === index ? 1 : 0.55 }}>
//                 <img src={thumb.img} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
//               </button>
//             ))}
//           </div>
...
//           <span style={{ fontSize: '0.7rem', color: 'var(--primary)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.6px' }}>{section.title}</span>
//           <h2 style={{ margin: '6px 0 1rem', fontFamily: 'var(--font-display)', fontSize: '1.6rem', fontWeight: 800, color: 'white' }}>{item.caption}</h2>
//           <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.88rem', lineHeight: 1.7, marginBottom: '1.5rem' }}>{section.tagline}</p>
